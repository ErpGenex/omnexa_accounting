...
"""Idempotent Frappe Workflow for Stock Entry and Stock Reconciliation."""

import frappe

STATE_DRAFT = "Omnexa Stock Draft"
STATE_SUBMITTED = "Omnexa Stock Submitted"
STATE_CANCELLED = "Omnexa Stock Cancelled"

ACTION_SUBMIT = "Submit"
ACTION_CANCEL = "Cancel"

WORKFLOW_BY_DOCTYPE = {
	"Stock Entry": "Omnexa Chain - Stock Entry",
	"Stock Reconciliation": "Omnexa Chain - Stock Reconciliation",
}
...
def ensure_inventory_workflows() -> None:
	"""Workflow State masters + one active workflow per Stock Entry / Stock Reconciliation."""
